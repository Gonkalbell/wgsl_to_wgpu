    ...
    async fn new(window: Window) -> Self {
        ...
        let render_pipeline_layout =
            device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
                label: None,
                bind_group_layouts: &[
                    &bind_groups::BindGroup0::create_bind_group_layout(&device),
                    &bind_groups::BindGroup1::create_bind_group_layout(&device),
                ],
            ...
            device.create_compute_pipeline(&wgpu::ComputePipelineDescriptor {
                ...
                layout: Some(
                    &device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
                        label: None,
                        bind_group_layouts: &[
                            &bind_groups::CSBindGroup0::create_bind_group_layout(&device),
                        ],
                        push_constant_ranges: &[],
                    }),
                ),
                module: &shader::create_shader_module(&device),
                entry_point: "main",
